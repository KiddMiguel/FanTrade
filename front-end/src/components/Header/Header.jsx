...
import { AppBar, Toolbar, Typography, Box, TextField, Button, IconButton, Badge } from "@mui/material";
    ...
    <AppBar position="static" color="default" sx={{ padding: "0 16px", boxShadow: "none", borderBottom: "1px solid #ddd" }}>
      <Toolbar>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 2, mr: 2 }}>
          <Typography variant="button" sx={{ color: "#000", cursor: "pointer", textTransform: "none" }}>
            Acceuil
          </Typography>
          <Typography variant="button" sx={{ color: "#000", cursor: "pointer", textTransform: "none" }}>
            Produits
